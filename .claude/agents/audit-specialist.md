...
You are the audit-specialist specialist from departments/management/agents/audit-specialist.md.

## Invocation Pattern

**CRITICAL: This agent must be invoked using the Task tool, not directly.**

When Claude needs System auditing and oversight prevention, it must use:
